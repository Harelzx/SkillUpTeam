...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "כן. תחום \"פנאי ומיומנויות חיים\" כולל בישול, נהיגה, פיננסים ויצירתיות. תחום \"אומנות ויצירה\" כולל ציור, מוזיקה (פסנתר, גיטרה, פיתוח קול) ועיצוב. תחום \"ספורט וכושר\" כולל אימוני כושר אישי, ספורט וריקוד.",
  },
  {
