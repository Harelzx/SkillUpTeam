...
export const PAIN_POINTS = [
  ...
  },
  {
    ...
    title: "תיאום שיעורים שמרגיש כמו עבודה?",
    description:
      "יומן, צ׳אט ותזכורות, הכול בתוך האפליקציה. רואים זמינות אמיתית של המורה וקובעים בכמה לחיצות. הקשר ביניכם לבין המורה ישיר, בלי מתווכים באמצע.",
  },
] as const;
...
export const FEATURES = [
  {
    ...
    description:
      "לוח שיעורים, מעקב תשלומים, תלמידים, הכנסות והתקשרות, הכול במקום אחד. משלמים ישירות למורה, ובאפליקציה פשוט מסמנים ששולם. תגידו שלום לאקסל ולמחברת.",
  ...
  },
  {
    ...
    description:
      "גרפי מגמה, יעדים אישיים ותמונת מצב של כל הקריירה, במבט אחד מתוך האפליקציה.",
    color: "cyan" as const,
  },
  {
    icon: "bolt" as const,
...
export const CATEGORIES = [
  ...
  },
  {
    ...
    subjects: ["בישול", "נהיגה", "פיננסים", "יצירתיות"],
    isNew: true,
  },
] as const;
...
export const QUICK_ANSWER =
  "SkillUp היא האפליקציה הישראלית למציאת מורים פרטיים ושיעורים פרטיים בכל הארץ. האפליקציה מחברת תלמידים, הורים ומבוגרים ישירות עם מורים פרטיים מאומתים ב-9 תחומים: מתמטיקה ומדעים, שפות זרות, עברית וספרות, בגרויות ופסיכומטרי, מדעי הרוח, ספורט, אומנות, תכנות, ופנאי ומיומנויות חיים (בישול, נהיגה, פיננסים). 3 דרכי לימוד: אונליין, אצל המורה, או אצלכם בבית. הקשר ישיר ביניכם לבין המורה, בלי מתווכים. ביטול גמיש בהתאם למדיניות הביטולים.";

// Founders' letter — replaces testimonials until real reviews land.
export const FOUNDER_LETTER =
  "בנינו את SkillUp כי מצאנו את עצמנו, כמו כל הורה ותלמיד בישראל, רודפים אחרי המלצות בקבוצות וואטסאפ, מתאמים שעות בטלפון ומקווים שהמורה שהגיע באמת יודע ללמד. רצינו שיהיה מקום אחד בעברית, על הטלפון, שבו רואים מורה מאומת, רואים ביקורות אמיתיות, רואים זמינות, ולוחצים. קשר ישיר ביניכם לבין המורה, בלי מתווכים, בלי הפתעות. SkillUp כאן, עכשיו, ואתם מוזמנים להיות חלק מההתחלה שלנו.";

// Tutor-side hooks for the For-Tutors grid (the app goes with you everywhere).
export const TUTOR_HOOKS = [
  {
    icon: "dashboard" as const,
    title: "בכיס, בכל מקום",
    description: "היומן, התלמידים וההודעות איתכם בכל רגע, מכל מקום.",
  },
  {
    icon: "bolt" as const,
    title: "התראה ברגע שתלמיד מחפש אתכם",
    description: "פוש בזמן אמת על כל פנייה או הזמנת שיעור חדשה. אתם עונים, השיעור נסגר.",
  },
  {
    icon: "chat" as const,
    title: "תלמידים חדשים מוצאים אתכם",
    description: "הפרופיל שלכם מופיע בחיפוש לפי תחום, אזור וזמינות, בדיוק מול מי שמחפש אתכם.",
  },
  {
    icon: "sparkle" as const,
    title: "חשיפה שלא הייתה לכם",
    description: "נראות בכל הארץ, וביקורות מתלמידים שעובדות בשבילכם גם כשאתם מלמדים.",
  },
] as const;
